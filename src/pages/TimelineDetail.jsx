...
const experience = [
  {
    ...
    rows: [
      ...
      { label: '주요 업무', value: '고속도로 및 일반국도 도로 설계, 노선 선정, 종횡단 설계, 사업관리' },
  ...
  },
  {
    ...
    current: false,
    rows: [
      { label: '직무', value: 'R&D 인턴' },
      { label: '주요 업무', value: '홍수 위험 모델링 데이터 분석 및 전처리' },
      { label: '기술 스택', value: 'QGIS, PostgerSQL, Python, GeoPandas' },
    ],
  },
  {
    period: '2025.09 – 현재',
    ...
    rows: [
      ...
      { label: '주요 업무', value: 'AI 기반 BIM 솔루션 개발' },
      { label: '기술 스택', value: 'Python, Pytorch, FastAPI, Open3D, OpenCV, Docker, Git' },
    ],
  },
];
...
const education = [
  ...
  },
  {
    ...
    current: false,
    rows: [
      { label: '과정', value: 'AI Agent 개발 트랙' },
      { label: '주요 학습', value: '데이터 분석, 머신 러닝, 딥러닝, Langchain을 활용한 에이전트 개발' },
      { label: '기술 스택', value: 'Python, Scikit-learn, Pytorch, OpenCV, LangChain, OpenAI API, FastAPI' },
    ],
  },
  {
    period: '2026.03 – 현재',
